...
function Stacked(props: Props) {
        ...
        if (stackedRef.current) {
            ...
            d3.csv('/data/duitsland_china.csv').then(function (data) {
                ...
                svg.append('text')
                    ...
                    .attr(
                        'x',
                        (props.isMobileSize ? widthMobile : widthDesktop) - 4
                    )
                    .attr(
                        'y',
                        (props.isMobileSize ? heightMobile : heightDesktop) / 11
                    )
                    .text('11%');
                ...
                svg.append('text')
                    ...
                    .attr(
                        'x',
                        (props.isMobileSize ? widthMobile : widthDesktop) / 2
                    )
                    .attr(
                        'y',
                        (props.isMobileSize ? heightMobile : heightDesktop) /
    ...
    return (
        <div
            ref={stackedRef}
            className={`${styles.stacked} ${visible ? styles.active : ''}`}
        >
